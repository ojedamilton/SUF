...
export default {
  props: ["path","modalFlag","userEmpresa","notacredito","arrayDetalles", "arrayClientes"],
  data() {
    return {
              ...
              <div class="modal-body" id="modal-body">
                <div class="col-12">
                  ...
                  <div class="row fact-info mt-3 col-12">
                    <div class="col-4">
                      <h5>Tipo Nota de Credito</h5>
                      <p>
                        {{notacredito.tipofactura.tipoFactura}}
                      </p>
                    </div>
                    <div class="col-4">
                      <h5>N° de nota de credito</h5>
                      <h5>Fecha</h5>
                    </div>
                    <div class="col-4">
                      <p>{{notacredito.puntoventa.numPuntoVenta}}-{{notacredito.numeroNotaCredito}}</p>
                      <p>{{notacredito.fechaNotaCredito}}</p>
                    </div>
                  </div>
                  <div class="row my-4">
                    <table class="table table-borderless notacredito">
                      <thead>
                        <tr>
                          <th>Cant.</th>
                          <th>Descripcion</th>
                      ...
                      <tfoot>
                        ...
                        <tr>
                          ...
                          <th class="font-weight-normal">{{ (notacredito.totalNotaCredito / (1 - this.notacredito.descuento / 100)).toFixed(2) }}</th>
                        </tr>
                        <tr>
                          <th></th>
                          <th></th>
                          <th class="font-weight-normal">Descuento</th>
                          <th class="font-weight-normal">{{ (notacredito.totalNotaCredito - (notacredito.totalNotaCredito / (1 - (notacredito.descuento / 100)))).toFixed(2) }}</th>
                        </tr>
                        <tr>
                          <th></th>
                          <th></th>
